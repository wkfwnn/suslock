...
#define AT_QLWCONF_TEST "AT+QLWCONF=\"866971032326675\"\r"
...
//设置数据接收模式为[direct push mode]
#define AT_QLWOPEN_0 "AT+QLWOPEN=0\r"
...
#define CON_MODE   "0x0100"  
#define AT_QLWDATASEND_CON_DATA_TEST "AT+QLWDATASEND=19,0,0,2,aa00,0x0100\r"



#define AT_QLWRD$   "AT+QLWRD=?\r" 
#define AT_QLWRD_TEST   "AT+QLWRD=5\r" 

#define AT_QLWUPDATE  "AT+QLWUPDATE\r"
...
#define QLWRD_VALUE "+QLWRD:"

#define CLOSE_OK "CLOSE OK"
#define CLOSE_FAIL "CLOSE FAIL"
//AT+CGATT? may return
...
At_commond_struct_t bc26_command[] = {
    ...
    {AT_CFUN_1, OK, {ERROR,RETURN_CME_ERROR_OTHER,NULL},5000, NULL, {NULL,NULL,NULL},0},
    {AT_CGPADDR_1,RETURN_CGPADDR_IMMEDIATELY,{OK,ERROR,NULL},300,NULL,{NULL,NULL,NULL},0},
    {AT_CGATT$, CGATT$,{ERROR,RETURN_CGATT$_OTHER,NULL},5000, NULL, 0},
    {AT_CEREG$,CEREG$,{ERROR,RETURN_CEREG$_OTHER,NULL},300,NULL,{NULL,NULL,NULL},0},
    //{AT_CSCON$,CEREG$,{ERROR,RETURN_CEREG$_OTHER,NULL},300,NULL,{NULL,NULL,NULL},0},
   ...
   // {AT_QSCLK_ENABLE_LIGHT_SLEEP_WAKEBY_MAIN_UART,OK,{ERROR,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
    ...
    {AT_QLWCONF,OK,{ERROR,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
   ...
   // {AT_QLWOPEN_1,OK,{ERROR,NULL,NULL},300,CONNECT_OK,{CONNECT_FAIL,NULL,NULL},5000},
    {AT_QLWOPEN_0,OK,{ERROR,NULL,NULL},300,CONNECT_OK,{CONNECT_FAIL,NULL,NULL},5000},
    {AT_QLWCFG_HEX_MODE,OK,{ERROR,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
    {AT_QLWDATASEND_CON,OK,{ERROR,NULL,NULL},300,SEND_OK,{SEND_FAIL,NULL,NULL},5000},
    {AT_QLWSERV_IP,OK,{ERROR,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
	{AT_QLWDATASEND_CON_DATA_TEST,OK,{ERROR,NULL,NULL},300,SEND_OK,{SEND_FAIL,NULL,NULL},5000},
	{AT_QLWCLOSE,OK,{ERROR,NULL,NULL},300,CLOSE_OK,{CLOSE_FAIL,NULL,NULL},5000},
    //{AT_QLWCONF_TEST,OK,{ERROR,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
    {AT_QLWDEL,OK,{ERROR,NULL,NULL},1000,NULL,{NULL,NULL,NULL},0},
	{AT_QLWRD$,QLWRD_VALUE,{OK,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
	{AT_QLWRD_TEST,QLWRD_VALUE,{OK,NULL,NULL},300,NULL,{NULL,NULL,NULL},0},
	{AT_QLWUPDATE,OK,{ERROR,NULL,NULL},300,UPDATE_OK,{UPDATE_FAIL,NULL,NULL},5000},
};
